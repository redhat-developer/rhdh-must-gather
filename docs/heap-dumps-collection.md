...
**For Operator-managed deployments**, patch the Backstage CR using the `spec.deployment.patch` field. Do not patch the generated Deployment directly, otherwise your changes will be reverted upon the next reconciliation.
