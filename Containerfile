FROM registry.access.redhat.com/ubi9-minimal:latest@sha256:fe688da81a696387ca53a4c19231e99289591f990c904ef913c51b6e87d4e4df
...
RUN curl -sSLo- https://github.com/mikefarah/yq/releases/download/v4.52.5/yq_linux_amd64.tar.gz | tar xz \
...
RUN curl -fsSL "https://get.helm.sh/helm-v4.1.3-linux-amd64.tar.gz" -o helm.tar.gz \
    && tar xzf helm.tar.gz \
