FROM registry.access.redhat.com/ubi9-minimal:latest@sha256:69f5c9886ecb19b23e88275a5cd904c47dd982dfa370fbbd0c356d7b1047ef68
...
RUN curl -sSLo- https://github.com/mikefarah/yq/releases/download/v4.52.4/yq_linux_amd64.tar.gz | tar xz \
